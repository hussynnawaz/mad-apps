...
const teachers = [
    new Teacher(1, "Dr. Kashif Bilal", 35, 150000, "Assistant Professor", "Computer Science", "2010-08-01"),
    new Teacher(2, "Dr. Osman Khalid", 40, 160000, "Professor", "Computer Science", "2015-01-01"),
    new Teacher(3, "Mr. Jawad Khan", 34, 140000, "Lecturer", "Software Engineering", "2019-08-01")
];
